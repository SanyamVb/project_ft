...
print(f"EXPERIMENT: add_generation_prompt=True, 20 Epochs")
print(f"{'='*80}\n")
...
training_args = TrainingArguments(
    output_dir="./qwen3_gen_prompt_true_20epochs",
    num_train_epochs=20,
...
# Training
print(f"\n{'='*80}")
print("Starting Training (20 Epochs, add_generation_prompt=True)")
print(f"{'='*80}\n")
...
# Save final model
final_model_path = "models/qwen3_gen_prompt_true_20epochs"
...
final_metrics = {
    ...
    "experiment": "add_generation_prompt_true_20epochs",
