...
training_args = TrainingArguments(
    ...
    per_device_train_batch_size=4,  # Minimum for memory constraints
    gradient_accumulation_steps=4,  # Effective batch size of 24
...
# Train for 10 epochs with automatic evaluation after each epoch
print(f"\n{'='*80}")
